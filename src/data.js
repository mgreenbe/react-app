...
export const source = `<div>{{#each people}}
    <p><label>Name:</label><input className="form-control" value="{{name}}" data-path="people[{{@index}}].name" /></p>
    <label>Kids:</label>
    {{#each kids}}
      <div className="input-group">
        <input className="form-control" value="{{this}}" data-path="people[{{@../index}}].kids[{{@index}}]" />
    ...
    <br /><br />
{{/each}}
<button className="btn btn-default" data-action="ADD" data-path="people">Add person</button></div>`
